    ...
    return (
        <>
            ...
            <Animated.View style={{ height: headerHeight, overflow: 'hidden' }}>
                <ImageBackground source={image} style={{ flex: 1 }} blurRadius={5}>
            ...
            {/* Song Sections */}
            <Animated.ScrollView
                contentContainerStyle={{ padding: 16, backgroundColor: '#BAA1F2', paddingBottom: 100 }}
